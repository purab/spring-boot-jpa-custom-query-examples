package in.purabtech.customquery;

import in.purabtech.customquery.model.Tutorial;
import in.purabtech.customquery.repository.TutorialRepository;
...
public class SpringBootJpaCustomQueryExamplesApplication implements CommandLineRunner {

    @Autowired
    TutorialRepository tutorialRepository;

    public static void main(String[] args) {
        SpringApplication.run(SpringBootJpaCustomQueryExamplesApplication.class, args);
    }
